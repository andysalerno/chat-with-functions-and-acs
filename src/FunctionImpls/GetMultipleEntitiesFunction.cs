...
/// </summary>
internal class GetMultipleEntitiesFunction : IFunction
{
    private readonly AIClient _openAIClient;
    private readonly DataverseClient _dataverseClient;

    public GetMultipleEntitiesFunction(AIClient openAIClient, DataverseClient dataverseClient)
    {
        _openAIClient = openAIClient;
        _dataverseClient = dataverseClient;
    }

    public string FunctionName => "get_multiple_entities_sorted";

    public FunctionDefinition FunctionDefinition =>
        new FunctionBuilder(FunctionName)
            .WithDescription("Get multiple entities, sorted in some way.")
