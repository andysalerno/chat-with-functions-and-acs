...
internal class DataverseRelevancySearchFunction : IFunction
{
    private readonly AIClient _openAIClient;
    private readonly DataverseClient _dataverseClient;

    public DataverseRelevancySearchFunction(AIClient openAIClient, DataverseClient dataverseClient)
    {
